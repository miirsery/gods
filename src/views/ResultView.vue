...
export default {
  ...
  data() {
    return {
      position: {
        100: "Вы Один - всеотец. Легенды не лгали, перед нами настоящий мудрец",
        90: "Вы Тор - бог грома. Почесть надо заслужить, за отличное прохождение теста, вы заслужили её",
        80: "Вы Тюр - бог войны. Решать исход битв у вас получается куда лучше, чем проходить тесты",
        70: "Вы Вали - бог мести. Только не мстите нам за тест, он не такой уж и трудный",
        60: "Вы Фригга - королева Асгарда. Вы и вправду обладаете силой пророчества, вы же как-то набрали половину баллов",
        50: "Вы Фрейр - бог плодородия. Солнце всегда светит над вами, но с тестом вы справились посредственно",
        40: "Вы Ньерд - бог моря. Видимо, кроме моряков вам никто и ничто не нужно",
        30: "Вы Форсети - бог справедливости. О вас мало, что известно, но вы существуете",
        20: "Это фиаско...",
        10: "Это фиаско...",
        0: "Это фиаско..."
      },
